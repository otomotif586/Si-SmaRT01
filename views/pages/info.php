    ...
    <div id="info-umum" class="info-tab-content active-tab">
        <div class="grid-container-2-col mb-16">
            ...
            <div class="glass-card card-section">
                <h4 class="section-title mb-20"><i data-lucide="image" style="display:inline; width:20px; margin-right:8px;" class="text-accent"></i> SEO & Branding</h4>
                    ...
                    <div class="form-group">
                        ...
                        <div class="upload-premium-container mt-2" style="border-radius: 12px; padding: 0;">
                            ...
                            <div class="upload-premium-label" style="padding: 12px;">
                                ...
                                <span class="text-color text-size-075">Unggah Logo</span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="upload-premium-container mt-2" style="border-radius: 12px; padding: 0;">
                            ...
                            <div class="upload-premium-label" style="padding: 12px;">
                                <i data-lucide="upload" class="text-secondary icon-20"></i>
                                <span class="text-color text-size-075">Unggah Favicon</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Profil & Kontak -->
            <div class="glass-card card-section">
                <h4 class="section-title mb-20"><i data-lucide="building" style="display:inline; width:20px; margin-right:8px;" class="text-accent"></i> Profil & Kontak Publik</h4>
        ...
        <div class="grid-container-2-col mb-16">
            ...
            <div class="glass-card card-section">
                <h4 class="section-title mb-20"><i data-lucide="layout" style="display:inline; width:20px; margin-right:8px;" class="text-accent"></i> Tampilan Utama (Hero & Slider)</h4>
        ...
        <div class="glass-card card-section mb-24">
            <div class="section-header mb-20">
                <div>
                    ...
                    <p class="text-secondary text-size-08">Sesuaikan gambar dan teks untuk ketiga slide di halaman depan.</p>
                </div>
            </div>
        ...
        <div class="glass-card card-section mb-24">
            <div class="section-header mb-20">
                <div>
                    ...
                    <p class="text-secondary text-size-08">Sesuaikan gambar dan info wisata alam di sekitar kawasan.</p>
                </div>
            </div>
        ...
        <div class="glass-card card-section">
            <div class="section-header">
                <div>
                    ...
                    <p class="text-secondary text-size-08">Atur urutan dan link menu pada halaman depan website publik.</p>
                </div>
        ...
        <div class="glass-card card-section">
            <div class="section-header">
                <div>
                    ...
                    <p class="text-secondary text-size-08">Buat pengumuman atau artikel publik untuk Landing Page.</p>
                </div>
        ...
        <div class="glass-card card-section">
            <div class="section-header mb-24">
                <div>
                    ...
                    <p class="text-secondary text-size-08">Tampilkan informasi atau laporan saldo kas kepada warga di Landing Page depan.</p>
                </div>
            </div>
            <div class="form-group mb-16">
        ...
        <div class="glass-card card-section">
            <div class="section-header">
                <div>
                    ...
                    <p class="text-secondary text-size-08">Buat bagan susunan pengurus untuk ditampilkan di Landing Page publik. Angka tingkat yang sama akan sejajar.</p>
                </div>
...
<div id="modal-cms-menu" class="modal-overlay hidden overlay-z10020">
    <div class="glass-card modal-shell modal-shell-sm">
        ...
        <button class="button-primary button-full-center" onclick="saveCmsMenu()"><i data-lucide="save" style="margin-right: 8px;"></i> Simpan Menu</button>
    </div>
</div>
...
<div id="modal-cms-pengurus" class="modal-overlay hidden overlay-z10020">
    <div class="glass-card modal-shell modal-shell-sm">
        ...
        <div class="form-group mb-16">
            <label class="card-label flex-between">Tingkat (Urutan) <span class="text-emerald" style="font-size:0.7rem;"><i data-lucide="info" style="display:inline;width:12px;height:12px;"></i> 1 = Paling Atas</span></label>
        ...
        <div class="form-group mb-24">
            ...
            <div class="upload-premium-container mt-2" style="border-radius: 12px; padding: 0;">
                ...
                <div class="upload-premium-label" style="padding: 12px;"><i data-lucide="upload" class="text-secondary icon-20"></i><span class="text-color text-size-075">Unggah Foto</span></div>
            </div>
        </div>
        <button class="button-primary button-full-center" onclick="saveCmsPengurus()"><i data-lucide="save" style="margin-right: 8px;"></i> Simpan Anggota</button>
    </div>
</div>
